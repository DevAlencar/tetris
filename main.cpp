...
void drawRecyclingAnimation() {
    ...
    switch (type) {
        case PAPER: r = 0.3f; g = 0.5f; b = 1.0f; break;
        case PLASTIC: r = 1.0f; g = 0.3f; b = 0.3f; break;
        case METAL: r = 1.0f; g = 0.8f; b = 0.2f; break;
        case GLASS: r = 0.3f; g = 1.0f; b = 0.3f; break;
        case ORGANIC: r = 0.8f; g = 0.5f; b = 0.2f; break;
    }
